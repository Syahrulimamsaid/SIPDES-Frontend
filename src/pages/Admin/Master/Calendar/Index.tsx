...
export default function CalendarManagementAdmin() {
  ...
  return (
    <>
      <PageMeta
        title="Manajemen Kalender Kegiatan & Hari Libur - SIPDES"
        description="Kelola hari libur dan kegiatan penugasan perangkat desa"
      />
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Input dan atur hari libur atau agenda kegiatan tertentu yang memengaruhi rekapitulasi presensi.
            </p>
          </div>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-end gap-2 pt-4 border-t border-gray-100 dark:border-gray-800">
              ...
              <Button
                ...
                className="flex items-center gap-1.5 bg-red-500 text-white hover:bg-red-600 dark:bg-red-600 dark:hover:bg-red-700"
