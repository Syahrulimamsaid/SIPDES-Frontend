        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white sm:text-3xl">
              Dashboard Operator {stats?.village_name}
            </h1>
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
              Selamat datang kembali. Berikut rangkuman presensi wilayah {stats?.village_name} hari ini.
            </p>
          </div>
          ...
          <div className="rounded-3xl border border-gray-100 bg-white p-5 shadow-lg dark:border-gray-800 dark:bg-gray-900 transition-all duration-200 hover:-translate-y-1">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h4 className="mt-2 text-2xl font-bold text-gray-900 dark:text-white truncate max-w-[180px]" title={stats?.village_name}>
                  {stats?.village_name}
                </h4>
              </div>
